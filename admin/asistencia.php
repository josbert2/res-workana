...
<!-- End Google Tag Manager (noscript) -->
    ...
    <section>
        <div id="fecha">
            <?php echo utf8_encode(getDia()); ?><br>
            <?php echo $usuario; ?>
        </div>
        <br>
        <div id="titulo">
        ...
        <form>
            ...
            <div>
                ...
                <div class="left">
                    ...
                    <input class="input" type="text" id="meses" maxlength="2" placeholder="Ingrese Meses Iniciales">
                </div>
            </div>
            ...
            <div class="right">
                ...
                <input class="input" type="text" id="descuento" maxlength="3" value="0">
            </div>
