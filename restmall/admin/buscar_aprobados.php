...
<?php
    ...
    include_once ('est/header_disabled.php');
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <section class="formulario">
        ...
        <a href="exportar_la.php?bdesde=<?php echo $bdesde ?>&bhasta=<?php echo $bhasta ?>&class=<?php echo $class ?>" class="btn btn-success pull-right" target="_blank">Exportar Transacciones</a>
        ...
        <form action="buscar_aprobados.php" method="get" class="form_search">
            <div class="inputsss">
        ...
        <div class="accordion" id="accordionExample">
            <?php
            //Paginador
            $sql_register = mysqli_query($conn, "SELECT COUNT(*) as total_registro FROM pagos_clientes WHERE ((CAST(FEC_PAG AS DATE) >= '$bdesde') AND (CAST(FEC_PAG AS DATE) <= '$bhasta') AND (clase = 'A') AND (p.estado = 'S') ".$crol." ) ");
            /*if(!$sql_register){
                echo mysqli_error();
            }*/
            ...
            ELSE 'No Específica'
            END) AS responsecode, US.usuario FROM pagos_clientes p INNER JOIN user US on p.userid = US.userid WHERE ((CAST(FEC_PAG AS DATE) >= '$bdesde') AND (CAST(FEC_PAG AS DATE) <= '$bhasta') AND (clase = 'A') AND (p.estado = 'S') ".$crol." ) order BY FEC_PAG DESC LIMIT $desde, $por_pagina");
                            ...
                            <div id="collapse<?php echo $i; ?>" class="collapse" aria-labelledby="heading<?php echo $i; ?>" data-parent="#accordionExample">
                                <div class="card-body">
                                    <div>
                                        ...
                                        <b>Fecha TBK:</b> 
                                        <?php if(!empty($data["fecha_tbk"])){
                                        $newDate_tbk = date("d-m-Y H:i:s",strtotime($data["fecha_tbk"]));
                                        echo $newDate_tbk; } ?><br>
