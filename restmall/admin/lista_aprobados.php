...
<!-- End Google Tag Manager (noscript) -->
    ...
    <section class="formulario">
        ...
        <a href="exportar_lah.php?class=<?php echo $class ?>" class="btn btn-success" target="_blank">Exportar Clientes de hoy</a>
        ...
        <div class="accordion" id="accordionExample">
            ...
            //Paginador
            $sql_register = mysqli_query($conn, "SELECT COUNT(*) as total_registro FROM pagos_clientes WHERE ((CAST(FEC_PAG AS DATE) = '$fechahoy') AND (clase = 'A') AND (p.estado = 'S') ".$crol." ) ");
            ...
            ELSE 'No Específica'
            END) AS responsecode, US.usuario FROM pagos_clientes p INNER JOIN user US on p.userid = US.userid WHERE ((CAST(FEC_PAG AS DATE) = '$fechahoy') AND (clase = 'A') AND (p.estado = 'S') ".$crol." ) order BY FEC_PAG DESC LIMIT $desde, $por_pagina");
