...
if(isset($_POST['buyOrder'])){
    ...
    if(($result = "REVERSED") OR ($result = "NULLIFIED")) {
...
<h2><?php echo $message; ?> RETORNO <?php var_dump($result); ?></h2>
    <form action="https://planes.rest911.cl/restmall/reembolso.php" method="post">
